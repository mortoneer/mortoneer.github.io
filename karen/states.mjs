...
export const characters = [
  {
    name: 'Cinderella',
    states: [
      { name: 'TALKING_TO_CINDERELLA', base: 'TALKING', r: 100, g: 200, b: 255, brightness: 80, color: '#64C8FF' },
  ...
  },
  {
    name: 'Snow White',
    states: [
      { name: 'TALKING_TO_SNOW', base: 'TALKING', r: 255, g: 215, b: 0, brightness: 80, color: '#FFD700' },
      { name: 'YELLING_AT_SNOW', base: 'YELLING', r: 255, g: 0, b: 0, brightness: 150, color: '#FF0000' },
      { name: 'LISTENING_TO_SNOW', base: 'QUIET', r: 60, g: 40, b: 0, brightness: 40, color: '#3C2800' }
    ]
  },
  {
    name: 'Sleeping Beauty',
    states: [
      { name: 'TALKING_TO_SLEEPING', base: 'TALKING', r: 255, g: 20, b: 147, brightness: 80, color: '#FF1493' },
  ...
  },
  {
    name: 'Rapunzel',
    states: [
      { name: 'TALKING_TO_RAPUNZEL', base: 'TALKING', r: 173, g: 255, b: 47, brightness: 80, color: '#ADFF2F' },
  ...
  },
  {
    name: 'O.F.G.',
    states: [
      { name: 'TALKING_TO_OFG', base: 'TALKING', r: 200, g: 255, b: 255, brightness: 80, color: '#C8FFFF' },
